-- =====================================================
-- FIX OWNER_ID COLUMN IN PROPERTIES TABLE
-- =====================================================
...
BEGIN
    ...
    IF EXISTS (
        ...
        IF NOT EXISTS (
            ...
            RAISE NOTICE 'Renamed agent_id column to owner_id in properties table';
        ELSE
            RAISE NOTICE 'owner_id column already exists in properties table';
        END IF;
    ELSE
        RAISE NOTICE 'agent_id column does not exist in properties table';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE NOTICE 'Added owner_id column to properties table';
    ELSE
        RAISE NOTICE 'owner_id column already exists in properties table';
    END IF;
END $$;
...
-- Successfully updated database schema to use owner_id instead of agent_id